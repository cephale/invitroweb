...
export default function ProductPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* ===== Diagonal background wrapper: 卒啄同時 → Workflow → Skillmap → Agent ===== */}
      <div className="relative">
        {/* Single diagonal lavender background spanning all 4 sections */}
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background: "linear-gradient(168deg, transparent 5%, #eeeaf6 8%, #eeeaf6 88%, transparent 92%)",
          }}
        />
        {/* Pink blob on 卒啄同時 left side */}
        <div
          className="absolute left-[-3%] top-[2%] w-[300px] h-[300px] rounded-full opacity-25 pointer-events-none"
          style={{
            background: "radial-gradient(circle, #f0b0a0 0%, #f5d0c8 40%, transparent 70%)",
            filter: "blur(30px)",
          }}
        />

        {/* ===== 卒啄同時 Section ===== */}
        <section className="relative" style={{ height: "531px" }}>
        ...
        {/* ===== Workflow Module ===== */}
        <section className="relative" style={{ height: "538px" }}>
          <div className="max-w-[1200px] mx-auto h-full relative px-6">
        ...
        {/* ===== Agent Module ===== */}
        <section className="relative py-20 px-6" style={{ minHeight: "800px" }}>
      ...
      </div>{/* End diagonal background wrapper */}

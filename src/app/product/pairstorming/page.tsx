    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative bg-[#faf9f7] overflow-hidden" style={{ paddingTop: "60px" }}>
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center min-h-[700px]">
          ...
          <div className="relative flex-shrink-0 w-full md:w-[55%] flex items-end justify-center gap-4 pt-10">
            {/* Main app screenshot */}
            <div
              className="w-[340px] h-[580px] bg-contain bg-no-repeat bg-top rounded-lg shadow-lg"
              style={{
                backgroundImage: `url(${CDN}/5e8b34f969409f78efe36ee5_pairstorming.png)`,
              }}
            />
            {/* Overlapping smaller panels */}
            <div className="absolute bottom-12 right-0 flex flex-col gap-3">
              <div
                className="w-[300px] h-[200px] bg-contain bg-no-repeat bg-center rounded-lg shadow-md"
                style={{
                  backgroundImage: `url(${CDN}/5e8b34d8178e5ad37649700c_filter_box_agent.png)`,
                }}
              />
              <div
                className="w-[190px] h-[190px] bg-contain bg-no-repeat bg-center rounded-lg shadow-md self-end"
                style={{
          ...
          {/* Right: Title */}
          <div className="flex-1 md:pl-12 py-12 text-center md:text-right">
            <h1 className="text-navy text-5xl md:text-6xl lg:text-7xl font-black tracking-[0.08em] leading-tight">
              Pairstorming
            </h1>
            <p className="text-navy/70 text-lg md:text-xl mt-6 leading-relaxed font-medium">
              {"\u30A8\u30AD\u30B9\u30D1\u30FC\u30C8\u3078\u306E\u8FD1\u9053"}
              <br />
              {"\u4ED5\u4E8B\u3082\u6210\u9577\u3082\u540C\u6642\u306B\u5B8C\u4E86"}
            </p>
        ...
        <div className="max-w-[1100px] mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="text-center">
              <div
                className="w-full aspect-[4/3] bg-contain bg-no-repeat bg-center mx-auto"
                style={{ backgroundImage: `url(${card.img})` }}
              />
              <h3 className="text-navy/30 text-2xl md:text-3xl font-black tracking-[0.1em] mt-4 whitespace-pre-line leading-tight">
                {card.title}
              </h3>
              <p className="text-navy/60 text-sm mt-3 leading-relaxed whitespace-pre-line">
                {card.desc}
              </p>
            </div>
          ))}
      ...
      <section className="py-24 px-6 md:px-16">
        <div className="max-w-[900px] mx-auto text-center">
          <h2 className="text-navy text-4xl md:text-5xl font-black tracking-wider mb-6">
            {"\u5352\u5544\u540C\u6642"}
          </h2>
          <p className="text-navy/50 text-sm leading-relaxed max-w-2xl mx-auto">
            Workflow, Skillmap, Agent{"\u306E"}3{"\u3064\u306E\u8981\u7D20\u3067\u30EF\u30FC\u30AF\u30D5\u30ED\u30FC\u3092\u30D6\u30E9\u30C3\u30B7\u30E5\u30A2\u30C3\u30D7"}
            <br />
            {"\u30DA\u30A2\u30EF\u30FC\u30AF\u3067\u80FD\u529B\u62E1\u5F35\u3067\u304D\u308B"}
          </p>
          <div className="mt-10">
      ...
      <section className="py-20 px-6 md:px-16 bg-[#f9f9f9]">
        <div className="max-w-[1100px] mx-auto">
          <div className="flex items-baseline gap-4 mb-2">
            <h2 className="text-navy text-4xl md:text-5xl font-black tracking-wider">
              Workflow
            </h2>
            <span className="text-navy/30 text-xs tracking-widest uppercase">
              {"\u73FE\u5728\u5B9F\u88C5\u4E2D"}
            </span>
          </div>
          <p className="text-navy/60 text-sm leading-relaxed max-w-lg mb-10">
      ...
      <section className="py-20 px-6 md:px-16">
        <div className="max-w-[1100px] mx-auto">
          ...
          <p className="text-navy/60 text-sm leading-relaxed max-w-lg mb-4">
            {"\u500B\u4EBA\u3068\u30C1\u30FC\u30E0\u306E\u80FD\u529B\u3092\u8996\u899A\u5316"}
            <br />
            {"\u30B9\u30AD\u30EB\u3092\u7D10\u3065\u3051\u305F\u30EF\u30FC\u30AF\u30D5\u30ED\u30FC\u3092\u5B9F\u884C\u3057\u3001\u5C02\u9580\u30B9\u30AD\u30EB\u3092\u7FD2\u5F97\u3059\u308B"}
          </p>
          <span className="text-navy/20 text-xs tracking-widest uppercase">
            {"\u8A2D\u8A08\u4E2D"}
          </span>

          <div className="mt-8 space-y-3 text-navy/50 text-sm">
            <p>{"\u30BF\u30B9\u30AF\u3068\u30B9\u30AD\u30EB\u3092\u7D10\u4ED8\u3051"}</p>
